...
const namePrefix = "Eggs Of Knowledge";
const description = "2,500 unique eggs of knowledge bursting with color...can you find a rare golden egg?";
...
const PUBLIC_MINT_START_DATE = "2022-04-21T10:00:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00

// OPTIONAL CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PRESALE_MINT_START_DATE = null; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 1000; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0xa6f928959B42cF4a57f330D839736dB8db2b18b7"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = ["0xa6f928959B42cF4a57f330D839736dB8db2b18b7"]; // only update if you want to manually set the whitelisted addresses
